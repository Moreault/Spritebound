...
public class FrameEventTests : RecordTester<FrameEvent>
{
    ...
    {
        //Arrange
        var instance = Dummy.Build<FrameEvent>().With(x => x.Name, name).Create();
    ...
    {
        //Arrange
        var instance = Dummy.Create<FrameEvent>();
    ...
    [TestMethod]
    public void Ensure_HasBasicGetSetFunctionality() => Ensure.HasBasicGetSetFunctionality<FrameEvent>(Dummy);
}